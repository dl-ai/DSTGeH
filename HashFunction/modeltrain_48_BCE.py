...
logging.basicConfig(level=logging.INFO, filename='resnet18_bceloss_48.log', format="%(levelname)s:%(asctime)s:%(message)s")
...
for epoch in range(num_epochs):
    ...
    if epoch % 1 == 0:
        ...
        print(loss)
        logging.info(epoch)
        torch.save(model.state_dict(), '../data/cifar10/hashmodel/whole/48/cifar10_whole_hashmodel_48.pth')
