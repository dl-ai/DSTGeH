...
logging.basicConfig(level=logging.INFO, filename='test_hashcode_MM.log', format="%(levelname)s:%(asctime)s:%(message)s")

model_path_name = '../data/cifar10/hashmodel/whole/48/cifar10_whole_hashmodel_48_MM.pth'
hash_path = '../data/cifar10/hashcode/whole/48_MM'
