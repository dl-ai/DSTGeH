...
logging.basicConfig(level=logging.INFO, filename='euc_cifar10_whole_hashlabel_48.log', format="%(levelname)s:%(asctime)s:%(message)s")
...
if __name__ == "__main__":
    ...
    hashtags_file = h5py.File(os.path.join(__PATH__HASHLABEL, 'euc_cifar10_whole_hashlabel_48.h5'), 'w')
    count = 0
    hashtags = []
