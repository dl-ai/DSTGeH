...
logging.basicConfig(level=logging.INFO, filename='autoencoder_loss_48.log', format="%(levelname)s:%(asctime)s:%(message)s")
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 10 == 0:
            ...
            logging.info(loss_sum.item())
            print(epoch)
            torch.save(model.state_dict(), './autoencoder_cifar10_48.pth')
